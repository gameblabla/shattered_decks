 ...
 * Do not set bit 15 for 256-color mode: on 32X that bit is the MD
 * priority/through indicator for the palette entry, and setting it lets the
 * Genesis layer punch through the 32X image.  Opaqueness is handled by using
 * non-zero pixel indices and 16-bit framebuffer writes. */

...
#define WAIFU_SUPPORT_STANDARD_CARD_VARIANTS 4
#define WAIFU_SUPPORT_CARD_VARIANTS 6
...
#define WAIFU_SUPPORT_THUNDER_CARD_ID (WAIFU_CARD_COUNT + 4)
#define WAIFU_SUPPORT_TRAP_CARD_ID  (WAIFU_CARD_COUNT + 5)

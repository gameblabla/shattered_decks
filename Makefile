...
HEADLESS_SRCS = src/main.c src/game/ai.c src/game/deck.c src/game/palette.c src/engine/renderer3d.c src/engine/common.c src/engine/bmp_writer.c src/record/zmbv_mkv.c
SDL12_SRCS = src/platform/sdl12_main.c src/main.c src/game/ai.c src/game/deck.c src/game/palette.c src/engine/renderer3d.c src/engine/common.c src/engine/bmp_writer.c
...
$(TARGET): $(HEADLESS_SRCS) src/generated/waifu_assets.h src/generated/title_asset.h src/game/game_api.h src/game/ai.h src/game/deck.h src/game/palette.h
	$(CC) $(CFLAGS) -DWAIFU_FM_HEADLESS_TESTS $(INCLUDES) $(HEADLESS_SRCS) -lm -lz -o $@

sdl12: $(SDL12_TARGET)

$(SDL12_TARGET): $(SDL12_SRCS) src/generated/waifu_assets.h src/generated/title_asset.h src/game/game_api.h src/game/ai.h src/game/deck.h src/game/palette.h

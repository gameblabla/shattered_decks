...
- [Makefile.cd32x](/home/anonymous/Documents/DEV/Anime_card/waifu_card_game/Makefile.cd32x:1)
  ...
  - CD32X full-frame clears use `waifu_cd32x_fill_u8_parallel()` so the Slave SH-2 clears half of the 32X framebuffer while the Master clears the other half. The job mailbox is accessed through the uncached SDRAM mirror; keep it simple and synchronized before any 2D/UI drawing starts over the freshly cleared 3D frame.

...
- The VDC overlay palette selector is in two-color units: use selector offset 128 for absolute VCE entry base 256. Do not change both values to 256; that selects the wrong bank and can corrupt story RAINBOW/portrait colors by colliding with KING's low 8bpp palette.
